import { SCROLL_BOUNDRY, STAGE_HEIGHT, STAGE_PADDING, STAGE_WIDTH } from '../../../src/constants/stage.js';
...
export class Camera {
    ...
    update(time, context) {
this.position.y = -20 + Math.floor(Math.min(this.fighters[1].position.y, this.fighters[0].position.y) / 10);
