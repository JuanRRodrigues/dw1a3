...
export class Leona extends Fighter {
    ...
    image = document.querySelector('img[alt="leona"]');
    ...
    frames = new Map([
        ...
        ['hit-feet-2'[[[164, 8235, 109, 51,], [0, 0]], PushBox.IDLE]],
        ['hit-feet-3'[[[186, 770, 65, 103,], [0, 0]], PushBox.IDLE]],
        ['hit-feet-4'[[[303, 8242, 119, 49,], [0, 0]], PushBox.IDLE]],
        ['hit-feet-5'[[[444, 8230, 96, 62,], [0, 0]], PushBox.IDLE]],
        ['hit-feet-6'[[[566, 8228, 111, 51,], [0, 0]], PushBox.IDLE]],
        ['hit-feet-7'[[[706, 8268, 121, 28,], [0, 0]], PushBox.IDLE]],
        //adiconar mais
    ]);
